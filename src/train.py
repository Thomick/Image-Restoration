...
def train_VAE2():
    ...
    data_module = GenericDataModule("datasets", batch_size=16, phase="B")
...
def train_Mapping():
    ...
    vae1_encoder = VAE1.load_from_checkpoint(
        vae1_chkp_path, params=hparams, device="cpu"
    ).vae.encoder
    vae2 = VAE2.load_from_checkpoint(vae2_chkp_path, params=hparams, device="cpu").vae
